...
three docks fold, the split goes off and the hooks list with them, and leaving
puts back the layout focus folded. A panel opened under it — from `⌘K`, the
mark menu or a diagnostic — ends focus rather than being shut again.
