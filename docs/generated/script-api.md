...
**Functions:** `args`, `dark_mode`, `delta`, `device_id`, `focused`, `has_plugin`, `platform`, `plugin_version`, `plugins`, `quit`, `reload_script`, `tick`, `time`, `timings`, `unix_time`, `user_data_dir`
